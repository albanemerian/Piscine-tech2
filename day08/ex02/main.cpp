...
// void const_test(const DroidMemory& dm)
// {
//     dm.getFingerprint(); // First error: wrong function name (should be getFingerprint)
// }
...
//     // Fill memories with some data
//     dm += 42;
//     dn1 += 42;

//     // This line will trigger the deprecated copy warning
//     // Because we have a copy constructor but no copy assignment operator
//     dg = dm + dn1;
